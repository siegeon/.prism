...
from prism_service.api.agent_bridge import router as agent_bridge_router
...
from prism_service.api.deploy import router as deploy_router
...
from prism_service.api.system_activity import router as system_activity_router
...
from prism_service.api.workflows import router as workflows_router
...
api_router.include_router(agent_bridge_router, prefix="/agent-bridge", tags=["agent-bridge"])
...
api_router.include_router(system_activity_router, prefix="/system/activity", tags=["system-activity"])
