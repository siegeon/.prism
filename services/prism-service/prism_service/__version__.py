...
PRISM_VERSION = "7.12.24"

# Changelog-ish notes (free-form; keep short)
PRISM_VERSION_NOTES = (
    "7.12.24: green_gate is the TENTH and final conductor state with a real linked behavior -- all 10 now real. Same visibility-not-replacement pattern as red_gate: new POST /api/workflows/steps/green-gate-status reuses ConductorService._oracle_receipt_refusal directly, the exact same read-only call gate_adjudicator.py's own _pending_decline_reason already makes for green_gate reporting -- not a reimplementation, never calls adjudicate_green_gate or any write. green_gate stays a real, untouched WORKFLOW_STEPS state. Full conductor/gate/workflow/adjudicator test slice: 833 passed, 0 failed (explicit exit code captured, not the tail-pipe trap). "
