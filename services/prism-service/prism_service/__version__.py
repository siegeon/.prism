...
PRISM_VERSION_NOTES = (
    ...
    "same 4-field list. UI token formatters gain M/B tiers (shared "
    "web/src/lib/format.ts fmtTokens) so billion-scale totals render "
    "compactly. Also: import_unseen's sqlite connect gains timeout=5.0. "
