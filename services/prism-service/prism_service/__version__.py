...
PRISM_VERSION_NOTES = (
    ...
    "full->fields 92% smaller.) Mostly skill/guide METHODOLOGY; the one engine "
    "change is the additive task_list id filter. Tests: "
    "test_prism_guide_playbook.py (safe-fan-out) + test_conductor_lean_responses"
    ".py (by-id read). "
