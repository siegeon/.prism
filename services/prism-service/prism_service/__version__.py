...
PRISM_VERSION_NOTES = (
    ...
    "Skill/guide METHODOLOGY only — no gate/tool BEHAVIOR change (the v6.7.6 "
    "engine already supports it). Tests: tests/unit/test_prism_guide_playbook.py "
    "(safe-fan-out method assertions). "
