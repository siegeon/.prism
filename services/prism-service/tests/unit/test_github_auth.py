"""Unit tests for prism_service.services.github_auth.
...
def isolated_data_dir(tmp_path: Path, monkeypatch):
    """Point prism_service.config.DATA_DIR (and the github_auth CREDS_PATH derived
    ...
    import importlib
    from prism_service.services import github_auth as gh_mod
