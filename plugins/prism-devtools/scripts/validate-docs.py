...
class DocumentationScanner:
    ...
    def scan(self) -> Dict[str, FileNode]:
        ...
        # Skip third-party caches, worktree clones, model card downloads, and
        # generated graphify mirrors. These are gitignored and not authored
        # content, so broken links inside them are out of scope for the gate.
