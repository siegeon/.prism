...
- **NEVER commit directly to**: main, master, staging, develop
- **NEVER push** without explicit user instruction
- **NEVER auto-create PRs** — if a push fails, ask the user
- Before ANY commit: run `git branch --show-current` to verify
