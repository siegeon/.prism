...
const PREFLIGHT_SCHEMA = {
  type: 'object',
  required: ['ok', 'sane_branch', 'datenow_clean', 'daemon_ok', 'deps_present', 'identity_ok', 'halt_reason'],
  properties: {
    ok: { type: 'boolean' },
